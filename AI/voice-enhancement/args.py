...
parser.add_argument('--noise_dir', default='voice-enhancement/data/Train/noise', type=str)

parser.add_argument('--voice_dir', default='voice-enhancement/data/Train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='voice-enhancement/data/Train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='voice-enhancement/data/Train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='voice-enhancement/data/Train/sound/', type=str)
