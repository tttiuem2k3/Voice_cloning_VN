...
from text_to_speech_pro.TTS.tts.layers.bark.model import GPT, GPTConfig
from text_to_speech_pro.TTS.tts.layers.bark.model_fine import FineGPT, FineGPTConfig
